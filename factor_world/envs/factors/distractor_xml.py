...
from factor_world.envs.factors.xml_wrapper import XmlWrapper
from factor_world.envs.factors.env_utils import sample_object_positions_on_table
from factor_world.envs.factors.xml_utils import save_xml_with_distractors
...
class DistractorXmlWrapper(XmlWrapper):
    def __init__(
        ...
        if object_ids_range is not None:
            ...
            assert object_ids_range[1] < len(constants.OBJECT_NAMES), len(
                constants.OBJECT_NAMES
            )
        else:
